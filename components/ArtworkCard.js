...
//                   </Card.Text>
//                   {/* <Link href={objectID}><Button variant="outline-primary">{data.objectID}</Button></Link> */}
//                </Card.Body>
//             </Card>
//          </>
//       );
         ...
         <>
            <Card style={{ width: '18rem' }}>
               ...
               <Card.Body>
                  ...
                  <Link href="artwork/"{...objectID} ><Button variant="outline-primary">{data.objectID}</Button></Link>
               </Card.Body>
            </Card>
         </>
       );
